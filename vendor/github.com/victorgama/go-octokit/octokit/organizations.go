...
var (
	...
	OrganizationMembersURL = Hyperlink("/orgs/{org}/members")
)
...
func (t *OrganizationService) GetOrganizationMembers(uri *Hyperlink, uriParams M) (
	members []User, result *Result) {
	url, err := ExpandWithDefault(uri, &OrganizationMembersURL, uriParams)
	if err != nil {
